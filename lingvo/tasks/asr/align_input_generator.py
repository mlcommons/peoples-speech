...
class AsrInput(base_input_generator.BaseSequenceInputGenerator):
  ...
  def Params(cls):
    ...
    p.Define('static_vocabulary_table_path', '', 'Path to new-line delimited table of sample id keys')
  ...
  def _DataSourceFromFilePattern(self, file_pattern):
    ...
    def Proc(record):
      ...
      return [
          fval['uttid'], fval['frames'], src_paddings
      ], bucket_key
    ...
    return generic_input.GenericInput(
        ...
        dynamic_padding_constants=[0] * 2 + [1],
  ...
  def __init__(self, params):
    ...
    (utt_ids, src_frames, src_paddings), self._bucket_keys = self._BuildDataSource()
  ...
  def _InputBatch(self):
    ...
    batch.src = self._src
    # Bingo. TPUs don't support tf.string... If anyone there were some way to avoid enqueueing and dequeueing this in the first place...
