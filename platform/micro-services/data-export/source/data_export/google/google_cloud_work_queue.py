...
from data_export.google.redis_service import RedisService

class GoogleCloudWorkQueue(object):
    ...
    def __init__(self, config):
        ...
        self._db = redis.StrictRedis(**self.redis_service.kwargs())
