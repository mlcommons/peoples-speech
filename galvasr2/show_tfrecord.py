...
raw_dataset = tf.data.TFRecordDataset(
    "gs://the-peoples-speech-west-europe/forced-aligner/vad-segments-dump/small_dataset_under_20_MB_each/id=SchoolRules/part-00000-fb274d2c-65c5-4bd5-bce4-97696fc3cbb8.c000.tfrecord"
)
