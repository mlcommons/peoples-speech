...
if num_hid_layers == 0 and o.bottleneck_dim != 0:
    ...
    if o.bottleneck_trick:
        ...
        print(
            ...
            % (
                feat_dim,
                o.bottleneck_dim,
                (o.param_stddev_factor * Glorot(feat_dim, o.bottleneck_dim) * 0.75),
                0.1,
            )
        )
        ...
        print(
            ...
            % (
                ...
                (
                    ...
                    * Glorot(o.bottleneck_dim, num_hid_neurons)
                    * 0.75
                ),
                0.1,
                0.1,
    ...
    print(
        "%s <InputDim> %d <OutputDim> %d %s"
        % (o.activation_type, num_hid_neurons, num_hid_neurons, o.activation_opts)
    )  # Non-linearity
...
if num_hid_layers == 0:
    print(
        ...
        % (
            ...
            0.0,
            0.0,
            (o.param_stddev_factor * Glorot(feat_dim, num_leaves)),
        )
    )
    if o.with_softmax:
        if o.block_softmax_dims == "":
...
print(
    "<AffineTransform> <InputDim> %d <OutputDim> %d <BiasMean> %f <BiasRange> %f <ParamStddev> %f <MaxNorm> %f %s"
    % (
        feat_dim,
        num_hid_neurons,
        o.hid_bias_mean,
...
if o.with_dropout:
    print(
        "<Dropout> <InputDim> %d <OutputDim> %d %s"
        % (num_hid_neurons, num_hid_neurons, o.dropout_opts)
    )
    ...
    if o.bottleneck_trick:
        ...
        print(
            ...
            % (
                ...
                (
                    o.param_stddev_factor
                    * Glorot(num_hid_neurons, o.bottleneck_dim)
                    * 0.75
                ),
                0.1,
            )
        ...
        # 25% smaller stddev -> smaller gradient in prev. layer, 10x smaller learning rate for weigts & biases
        print(
            "<AffineTransform> <InputDim> %d <OutputDim> %d <BiasMean> %f <BiasRange> %f <ParamStddev> %f <LearnRateCoef> %f <BiasLearnRateCoef> %f <MaxNorm> %f %s"
            % (
                o.bottleneck_dim,
                num_hid_neurons,
                o.hid_bias_mean,
