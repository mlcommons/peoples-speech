...
def CheckArgs(args):
    ...
    args.lexicon_phonetic_decoding_pruned_handle = open(
        args.lexicon_phonetic_decoding_pruned, "w"
    )
...
def PruneProns(
    args, stats, ref_lexicon, lexicon_phonetic_decoding, lexicon_g2p, lexicon_g2p_probs
):
