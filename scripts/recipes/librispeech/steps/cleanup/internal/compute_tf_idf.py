...
def _get_args():
    ...
    parser.add_argument(
        ...
        help="If provided, IDF stats are loaded from this " "file",
    )
    parser.add_argument(
        "--output-idf-stats",
        type=argparse.FileType("w"),
        help="If providied, IDF stats are written to this " "file",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "docs",
        type=argparse.FileType("r"),
        help="Input documents in kaldi text format i.e. " "<document-id> <text>",
    )
    parser.add_argument(
        "tf_idf_file",
        type=argparse.FileType("w"),
