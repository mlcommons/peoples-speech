...
class XconfigGruLayer(XconfigLayerBase):
    ...
    def generate_gru_config(self):
        ...
        bptrunc_str = (
            "clipping-threshold={0}"
            " zeroing-threshold={1}"
            " zeroing-interval={2}"
            " recurrence-interval={3}"
            "".format(
                self.config["clipping-threshold"],
        ...
        repair_nonlin_str = (
            "self-repair-scale={0:.10f}".format(repair_nonlin)
            if repair_nonlin is not None
            else ""
        )
        ...
        if (
            re.search("param-mean", ng_per_element_scale_options) is None
            and re.search("param-stddev", ng_per_element_scale_options) is None
        ):
        ...
        configs.append(
            "component name={0}.W_z.xs_z type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3}".format(
        ...
        configs.append(
            "component name={0}.W_z.xs_r type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3}".format(
                name, input_dim + cell_dim, cell_dim, affine_str
            )
        )
        ...
        configs.append(
            "component name={0}.W_h.UW type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3}".format(
                name, input_dim + cell_dim, cell_dim, affine_str
            )
        )
        ...
        configs.append(
            "component name={0}.h1 type=ElementwiseProductComponent input-dim={1} output-dim={2}".format(
                name, 2 * cell_dim, cell_dim
            )
        )
        configs.append(
            "component name={0}.y1 type=ElementwiseProductComponent input-dim={1} output-dim={2}".format(
                name, 2 * cell_dim, cell_dim
            )
        )
        configs.append(
            "component name={0}.y2 type=ElementwiseProductComponent input-dim={1} output-dim={2}".format(
                name, 2 * cell_dim, cell_dim
            )
        )
        configs.append(
        ...
        configs.append("# z_t")
        configs.append(
            "component-node name={0}.z_t_pre component={0}.W_z.xs_z input=Append({1}, IfDefined(Offset({2}, {3})))".format(
        ...
        configs.append("# r_t")
        configs.append(
            "component-node name={0}.r_t_pre component={0}.W_z.xs_r input=Append({1}, IfDefined(Offset({2}, {3})))".format(
                name, input_descriptor, recurrent_connection, delay
            )
        )
        configs.append(
        ...
        configs.append("# h_t")
        configs.append(
            "component-node name={0}.h1_t component={0}.h1 input=Append({0}.r_t, IfDefined(Offset({1}, {2})))".format(
                name, recurrent_connection, delay
            )
        )
        configs.append(
            "component-node name={0}.h_t_pre component={0}.W_h.UW input=Append({1}, {0}.h1_t)".format(
        ...
        configs.append(
            "component-node name={0}.y1_t component={0}.y1 input=Append({0}.h_t, Sum(Scale(-1.0,{0}.z_t), Const(1.0, {1})))".format(
                name, cell_dim
            )
        )
        configs.append(
            "component-node name={0}.y2_t component={0}.y2 input=Append(IfDefined(Offset({1}, {2})), {0}.z_t)".format(
                name, recurrent_connection, delay
            )
        )
        configs.append(
            "component-node name={0}.y_t component={0}.y input=Sum({0}.y1_t, {0}.y2_t)".format(
                name
            )
        )
        ...
        configs.append(
            "component name={0}.s_r type=BackpropTruncationComponent dim={1} {2}".format(
...
class XconfigPgruLayer(XconfigLayerBase):
    ...
    def set_derived_configs(self):
        ...
        if self.config["non-recurrent-projection-dim"] <= 0:
            self.config["non-recurrent-projection-dim"] = self.config[
                "recurrent-projection-dim"
            ]
    ...
    def check_configs(self):
        ...
        if (
            ...
            raise RuntimeError(
                "recurrent+non-recurrent projection dim exceeds " "cell dim."
            )
        for key in ["self-repair-scale-nonlinearity"]:
            if self.config[key] < 0.0 or self.config[key] > 1.0:
                raise RuntimeError(
                    "{0} has invalid value {2}.".format(
    ...
    def output_name(self, auxiliary_output=None):
        ...
        if auxiliary_output is not None:
            if auxiliary_output in self.auxiliary_outputs():
                ...
                raise Exception(
                    "In {0} of type {1}, unknown auxiliary output name {1}".format(
    ...
    def generate_pgru_config(self):
        ...
        # TODO: decide if we want to keep exposing these options
        if (
            re.search("param-mean", pes_str) is None
            and re.search("param-stddev", pes_str) is None
        ):
        ...
        configs.append(
            "component name={0}.W_s.ys type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3}".format(
        ...
        configs.append(
            "component-node name={0}.sn_t component={0}.W_s.ys input={0}.y_t".format(
                name
            )
        )
        configs.append(
            "dim-range-node name={0}.s_t_preclip input-node={0}.sn_t dim-offset=0 dim={1}".format(
                name, rec_proj_dim
            )
        )
        configs.append(
            "component-node name={0}.s_t component={0}.s_r input={0}.s_t_preclip".format(
                name
            )
        )
...
class XconfigNormPgruLayer(XconfigLayerBase):
    ...
    def generate_pgru_config(self):
        ...
        if dropout_proportion != -1.0:
            configs.append(
                "component-node name={0}.z_predrop_t component={0}.z input={0}.z_t_pre".format(
                    name
                )
            )
            configs.append(
                "component-node name={0}.z_t component={0}.dropout_z input={0}.z_predrop_t".format(
                    name
                )
            )
        else:
            configs.append(
                "component-node name={0}.z_t component={0}.z input={0}.z_t_pre".format(
                    name, input_descriptor, recurrent_connection, delay
                )
            )
        ...
        if dropout_proportion != -1.0:
            configs.append(
                "component-node name={0}.r_predrop_t component={0}.r input={0}.r_t_pre".format(
                    name
                )
            )
            configs.append(
                "component-node name={0}.r_t component={0}.dropout_r input={0}.r_predrop_t".format(
                    name
                )
            )
        else:
            configs.append(
                "component-node name={0}.r_t component={0}.r input={0}.r_t_pre".format(
                    name
                )
            )
        ...
        configs.append(
            "component name={0}.batchnorm type=BatchNormComponent dim={1} target-rms=1.0".format(
                name, rec_proj_dim + nonrec_proj_dim
            )
        )
        configs.append(
            "component name={0}.renorm type=NormalizeComponent dim={1} target-rms=1.0".format(
                name, rec_proj_dim
            )
        )
        ...
        configs.append("# s_t and n_t : sn_t will be the output")
        configs.append(
            "component-node name={0}.sn_nobatchnorm_t component={0}.W_s.ys input={0}.y_t".format(
                name
            )
        )
        configs.append(
            "dim-range-node name={0}.s_t_preclip input-node={0}.sn_nobatchnorm_t dim-offset=0 dim={1}".format(
                name, rec_proj_dim
            )
        )
        configs.append(
            "component-node name={0}.sn_t component={0}.batchnorm input={0}.sn_nobatchnorm_t".format(
                name
            )
        )

        configs.append(
            "component-node name={0}.s_renorm_t component={0}.renorm input={0}.s_t_preclip".format(
                name
            )
        )
        configs.append(
            "component-node name={0}.s_t component={0}.s_r input={0}.s_renorm_t".format(
                name
            )
        )
...
class XconfigOpgruLayer(XconfigLayerBase):
    ...
    def generate_pgru_config(self):
        ...
        configs.append(
            "component name={0}.W_z.xs_o type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3}".format(
                name, input_dim + rec_proj_dim, cell_dim, affine_str
            )
        )
        ...
        configs.append(
            "component name={0}.W_h.UW_elementwise type=NaturalGradientPerElementScaleComponent dim={1} {2}".format(
        ...
        configs.append("# Defining the components for other cell computations")
        configs.append(
            "component name={0}.o1 type=ElementwiseProductComponent input-dim={1} output-dim={2}".format(
                name, 2 * cell_dim, cell_dim
            )
        )
        configs.append(
        ...
        configs.append("# o_t")
        configs.append(
            "component-node name={0}.o_t_pre component={0}.W_z.xs_o input=Append({1}, IfDefined(Offset({2}, {3})))".format(
                name, input_descriptor, recurrent_connection, delay
            )
        )
        configs.append(
        ...
        configs.append("# h_t")
        configs.append(
            "component-node name={0}.h_t_pre component={0}.W_h.UW input={1}".format(
                name, input_descriptor
            )
        )
        configs.append(
            "component-node name={0}.h_t_pre2 component={0}.W_h.UW_elementwise input=IfDefined(Offset({1}, {2}))".format(
                name, recurrent_connection_y, delay
            )
        )
        configs.append(
            "component-node name={0}.h_t component={0}.h input=Sum({0}.h_t_pre, {0}.h_t_pre2)".format(
                name
            )
        )
        ...
        configs.append(
            "component-node name={0}.y_o_t component={0}.o1 input=Append({0}.o_t, {0}.y_t)".format(
                name
            )
        )
        ...
        configs.append("# s_t and n_t : sn_t will be the output")
        configs.append(
            "component-node name={0}.sn_t component={0}.W_s.ys input={0}.y_o_t".format(
                name
            )
        )
        configs.append(
...
class XconfigNormOpgruLayer(XconfigLayerBase):
    ...
    def generate_pgru_config(self):
        ...
        l2_regularize_option = (
            "l2-regularize={0} ".format(l2_regularize) if l2_regularize != 0.0 else ""
        )
        ...
        configs.append("# Update gate control : W_z* matrics")
        configs.append(
            "component name={0}.W_z.xs_z type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3} {4}".format(
                name,
                input_dim + rec_proj_dim,
                cell_dim,
                affine_str,
                l2_regularize_option,
            )
        ...
        configs.append("# Output gate control : W_r* matrics")
        configs.append(
            "component name={0}.W_z.xs_o type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3} {4}".format(
                name,
                input_dim + rec_proj_dim,
                cell_dim,
                affine_str,
        ...
        configs.append("# h related matrix : W_h* matrics")
        configs.append(
            "component name={0}.W_h.UW type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3} {4}".format(
        ...
        if dropout_proportion != -1.0:
            ...
            configs.append(
                "component-node name={0}.z_t component={0}.dropout input={0}.z_predrop_t".format(
                    name
                )
            )
        else:
        ...
        if dropout_proportion != -1.0:
            configs.append(
                "component-node name={0}.o_predrop_t component={0}.o input={0}.o_t_pre".format(
                    name
                )
            )
            configs.append(
                "component-node name={0}.o_t component={0}.dropout input={0}.o_predrop_t".format(
                    name
                )
            )
        else:
            configs.append(
                "component-node name={0}.o_t component={0}.o input={0}.o_t_pre".format(
                    name
                )
            )
        ...
        configs.append("# s_t recurrent")
        configs.append(
            "component name={0}.W_s.ys type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3} {4}".format(
                name,
                cell_dim,
                rec_proj_dim + nonrec_proj_dim,
                affine_str,
                l2_regularize_option,
            )
        )
        ...
        configs.append("# s_t and n_t : sn_t will be the output")
        configs.append(
            "component-node name={0}.sn_nobatchnorm_t component={0}.W_s.ys input={0}.y_o_t".format(
                name
            )
        )
        configs.append(
        ...
        configs.append(
            "component-node name={0}.s_t_preclip_renorm component={0}.renorm input={0}.s_t_preclip".format(
                name
            )
        )
        configs.append(
            "component-node name={0}.s_t component={0}.s_r input={0}.s_t_preclip_renorm".format(
                name
            )
        )
...
class XconfigFastGruLayer(XconfigLayerBase):
    ...
    def generate_gru_config(self):
        ...
        configs.append(
            "component name={0}.W_z.xh type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3}".format(
                name, input_dim + cell_dim, cell_dim, affine_str
            )
        )
        configs.append("# Reset gate control : W_r* matrices")
        configs.append(
            "component name={0}.W_r.xh type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3}".format(
                name, input_dim + cell_dim, cell_dim, affine_str
            )
        )
        ...
        configs.append(
            "component name={0}.W_hpart.x type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3}".format(
                name, input_dim, cell_dim, affine_str
            )
        )
        ...
        configs.append("# z_t")
        configs.append(
            "component-node name={0}.z_t_pre component={0}.W_z.xh input=Append({1}, IfDefined(Offset({2}, {3})))".format(
                name, input_descriptor, recurrent_connection, delay
            )
        )
        configs.append(
        ...
        configs.append("# r_t")
        configs.append(
            "component-node name={0}.r_t_pre component={0}.W_r.xh input=Append({1}, IfDefined(Offset({2}, {3})))".format(
                name, input_descriptor, recurrent_connection, delay
            )
        )
        configs.append(
        ...
        configs.append(
            "component-node name={0}.hpart_t component={0}.W_hpart.x input={1}".format(
                name, input_descriptor
            )
        )
        ...
        configs.append(
            "component name={0}.gru_nonlin type=GruNonlinearityComponent cell-dim={1} {2}".format(
                name, cell_dim, gru_nonlin_str
            )
        )
        configs.append(
            "component-node name={0}.gru_nonlin_t component={0}.gru_nonlin input=Append({0}.z_t, {0}.r_t, {0}.hpart_t, IfDefined(Offset({1}, {2})))".format(
                name, recurrent_connection, delay
            )
        )
        configs.append(
            "dim-range-node name={0}.y_t input-node={0}.gru_nonlin_t dim-offset={1} dim={1}".format(
                name, cell_dim
            )
        )
...
class XconfigFastPgruLayer(XconfigLayerBase):
    ...
    def generate_pgru_config(self):
        ...
        configs.append("# Update gate control : W_z* matrices")
        configs.append(
            "component name={0}.W_z.xs type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3}".format(
                name, input_dim + rec_proj_dim, cell_dim, affine_str
            )
        )
        configs.append("# Reset gate control : W_r* matrices")
        configs.append(
            "component name={0}.W_r.xs type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3}".format(
                name, input_dim + rec_proj_dim, rec_proj_dim, affine_str
            )
        )
        ...
        configs.append(
            "component-node name={0}.z_t_pre component={0}.W_z.xs input=Append({1}, IfDefined(Offset({2}, {3})))".format(
                name, input_descriptor, recurrent_connection, delay
            )
        )
        configs.append(
        ...
        configs.append(
            "component-node name={0}.r_t_pre component={0}.W_r.xs input=Append({1}, IfDefined(Offset({2}, {3})))".format(
                name, input_descriptor, recurrent_connection, delay
            )
        )
        configs.append(
        ...
        configs.append(
            "component name={0}.gru_nonlin type=GruNonlinearityComponent cell-dim={1} recurrent-dim={2} {3}".format(
                name, cell_dim, rec_proj_dim, gru_nonlin_str
            )
        )
        configs.append(
            "component-node name={0}.gru_nonlin_t component={0}.gru_nonlin input=Append({0}.z_t, {0}.r_t, {0}.hpart_t, IfDefined(Offset({0}.c_t, {2})), IfDefined(Offset({1}, {2})))".format(
                name, recurrent_connection, delay
            )
        )
        configs.append(
            "dim-range-node name={0}.c_t input-node={0}.gru_nonlin_t dim-offset={1} dim={1}".format(
                name, cell_dim
            )
        )
        ...
        configs.append(
            "component name={0}.W_y.c type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3}".format(
                name, cell_dim, rec_proj_dim + nonrec_proj_dim, affine_str
            )
        )
        configs.append(
        ...
        configs.append(
            "dim-range-node name={0}.s_t_pre input-node={0}.y_t dim-offset=0 dim={1}".format(
                name, rec_proj_dim
            )
        )
        configs.append(
            "component-node name={0}.s_t component={0}.s_r input={0}.s_t_pre".format(
                name
            )
        )
        return configs
...
class XconfigFastNormPgruLayer(XconfigLayerBase):
    ...
    def generate_pgru_config(self):
        ...
        if dropout_proportion != -1.0:
            configs.append(
                "component-node name={0}.z_t_predrop component={0}.z input={0}.z_t_pre".format(
                    name
                )
            )
            configs.append(
                "component-node name={0}.z_t component={0}.dropout_z input={0}.z_t_predrop".format(
                    name
                )
            )
        else:
        ...
        if dropout_proportion != -1.0:
            configs.append(
                "component-node name={0}.r_t_predrop component={0}.r input={0}.r_t_pre".format(
                    name
                )
            )
            configs.append(
                "component-node name={0}.r_t component={0}.dropout_r input={0}.r_t_predrop".format(
                    name
                )
            )
        else:
        ...
        configs.append(
            "component-node name={0}.y_t_tmp component={0}.W_y.c input={0}.c_t".format(
                name
            )
        )
        ...
        configs.append(
            "dim-range-node name={0}.s_t_pre input-node={0}.y_t_tmp dim-offset=0 dim={1}".format(
                name, rec_proj_dim
            )
        )
        configs.append(
            "component-node name={0}.s_t_renorm component={0}.renorm input={0}.s_t_pre".format(
                name
            )
        )
        configs.append(
            "component-node name={0}.s_t component={0}.s_r input={0}.s_t_renorm".format(
                name
            )
        )
        ...
        configs.append(
            "component-node name={0}.y_t component={0}.batchnorm input={0}.y_t_tmp".format(
                name
            )
        )
        return configs
...
class XconfigFastOpgruLayer(XconfigLayerBase):
    ...
    def generate_pgru_config(self):
        ...
        configs.append(
            "component name={0}.W_o.xs type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3}".format(
                name, input_dim + rec_proj_dim, cell_dim, affine_str
            )
        )
        ...
        configs.append(
            "component-node name={0}.o_t_pre component={0}.W_o.xs input=Append({1}, IfDefined(Offset({2}, {3})))".format(
                name, input_descriptor, recurrent_connection, delay
            )
        )
        configs.append(
        ...
        configs.append(
            "component name={0}.gru_nonlin type=OutputGruNonlinearityComponent cell-dim={1} {2}".format(
                name, cell_dim, gru_nonlin_str
            )
        )
        configs.append(
            "component-node name={0}.gru_nonlin_t component={0}.gru_nonlin input=Append({0}.z_t, {0}.hpart_t, IfDefined(Offset({0}.c_t, {1})))".format(
                name, delay
            )
        )
        configs.append(
        ...
        configs.append(
            "component name={0}.cdoto type=ElementwiseProductComponent input-dim={1} output-dim={2}".format(
                name, 2 * cell_dim, cell_dim
            )
        )
        configs.append(
            "component-node name={0}.cdoto component={0}.cdoto input=Append({0}.c_t, {0}.o_t)".format(
                name
            )
        )
        configs.append(
            "component name={0}.W_y.cdoto type=NaturalGradientAffineComponent input-dim={1} output-dim={2} {3}".format(
                name, cell_dim, rec_proj_dim + nonrec_proj_dim, affine_str
            )
        )
        configs.append(
            "component-node name={0}.y_t component={0}.W_y.cdoto input={0}.cdoto".format(
                name
            )
        )
        ...
        configs.append(
            "dim-range-node name={0}.s_t_preclip input-node={0}.y_t dim-offset=0 dim={1}".format(
                name, rec_proj_dim
            )
        )
        configs.append(
...
class XconfigFastNormOpgruLayer(XconfigLayerBase):
    ...
    def generate_pgru_config(self):
        ...
        if dropout_proportion != -1.0:
            ...
            configs.append(
                "component-node name={0}.z_t component={0}.dropout input={0}.z_t_predrop".format(
                    name
                )
            )
        else:
        ...
        if dropout_proportion != -1.0:
            configs.append(
                "component-node name={0}.o_t_predrop component={0}.o input={0}.o_t_pre".format(
                    name
                )
            )
            configs.append(
                "component-node name={0}.o_t component={0}.dropout input={0}.o_t_predrop".format(
                    name
                )
            )
        else:
        ...
        configs.append(
            "component-node name={0}.y_t_tmp component={0}.W_y.cdoto input={0}.cdoto".format(
                name
            )
        )
