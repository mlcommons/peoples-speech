...
class XconfigLstmLayer(XconfigLayerBase):
    ...
    def _generate_lstm_config(self):
        ...
        configs.append(
            "component name={0}.W_i.xr type=NaturalGradientAffineComponent input-dim={1} "
            "output-dim={2} {3} {4}".format(
                name, input_dim + cell_dim, cell_dim, affine_str, l2_regularize_option
            )
        )
        configs.append("# note : the cell outputs pass through a diagonal matrix")
        configs.append(
            "component name={0}.w_i.c type=NaturalGradientPerElementScaleComponent "
            "dim={1} {2} {3} ".format(name, cell_dim, pes_str, l2_regularize_option)
        )
        configs.append("# Forget gate control : W_f* matrices")
        configs.append(
            "component name={0}.W_f.xr type=NaturalGradientAffineComponent input-dim={1} "
            "output-dim={2} {3} {4}".format(
                name, input_dim + cell_dim, cell_dim, affine_str, l2_regularize_option
            )
        )
        configs.append("# note : the cell outputs pass through a diagonal matrix")
        configs.append(
            "component name={0}.w_f.c type=NaturalGradientPerElementScaleComponent "
            "dim={1} {2} {3}".format(name, cell_dim, pes_str, l2_regularize_option)
        )

        configs.append("#  Output gate control : W_o* matrices")
        configs.append(
            "component name={0}.W_o.xr type=NaturalGradientAffineComponent input-dim={1} "
            "output-dim={2} {3} {4}".format(
                name, input_dim + cell_dim, cell_dim, affine_str, l2_regularize_option
            )
        )
        configs.append("# note : the cell outputs pass through a diagonal matrix")
        configs.append(
            "component name={0}.w_o.c type=NaturalGradientPerElementScaleComponent "
            " dim={1} {2} {3}".format(name, cell_dim, pes_str, l2_regularize_option)
        )

        configs.append("# Cell input matrices : W_c* matrices")
        configs.append(
            "component name={0}.W_c.xr type=NaturalGradientAffineComponent input-dim={1} "
            "output-dim={2} {3} {4}".format(
                name, input_dim + cell_dim, cell_dim, affine_str, l2_regularize_option
            )
        )
        ...
        configs.append(
            "component name={0}.i type=SigmoidComponent dim={1} {2}".format(
                name, cell_dim, repair_nonlin_str
            )
        )
        configs.append(
            "component name={0}.f type=SigmoidComponent dim={1} {2}".format(
                name, cell_dim, repair_nonlin_str
            )
        )
        configs.append(
        ...
        configs.append(
            "component name={0}.g type=TanhComponent dim={1} {2}".format(
                name, cell_dim, repair_nonlin_str
            )
        )
        configs.append(
        ...
        configs.append(
            "component name={0}.c1 type=ElementwiseProductComponent input-dim={1} output-dim={2}"
            "".format(name, 2 * cell_dim, cell_dim)
        )
        configs.append(
            "component name={0}.c2 type=ElementwiseProductComponent input-dim={1} output-dim={2}"
            "".format(name, 2 * cell_dim, cell_dim)
        )
        configs.append(
            "component name={0}.m type=ElementwiseProductComponent input-dim={1} output-dim={2}"
            "".format(name, 2 * cell_dim, cell_dim)
        )
        configs.append(
            "component name={0}.c type=BackpropTruncationComponent dim={1} {2}"
            "".format(name, cell_dim, bptrunc_str)
        )

        # c1_t and c2_t defined below
        configs.append(
            "component-node name={0}.c_t component={0}.c input=Sum({0}.c1_t, {0}.c2_t)".format(
                name
            )
        )
        ...
        configs.append("# i_t")
        configs.append(
            "component-node name={0}.i1_t component={0}.W_i.xr input=Append({1}, IfDefined(Offset({0}.r_t, {2})))"
            "".format(name, input_descriptor, delay)
        )
        configs.append(
            "component-node name={0}.i2_t component={0}.w_i.c  input={1}".format(
                name, delayed_c_t_descriptor
            )
        )
        configs.append(
            "component-node name={0}.i_t component={0}.i input=Sum({0}.i1_t, {0}.i2_t)".format(
                name
            )
        )
        ...
        configs.append("# f_t")
        configs.append(
            "component-node name={0}.f1_t component={0}.W_f.xr input=Append({1}, IfDefined(Offset({0}.r_t, {2})))"
            "".format(name, input_descriptor, delay)
        )
        configs.append(
            "component-node name={0}.f2_t component={0}.w_f.c  input={1}".format(
                name, delayed_c_t_descriptor
            )
        )
        configs.append(
            "component-node name={0}.f_t component={0}.f input=Sum({0}.f1_t, {0}.f2_t)".format(
                name
            )
        )
        ...
        configs.append("# o_t")
        configs.append(
            "component-node name={0}.o1_t component={0}.W_o.xr input=Append({1}, IfDefined(Offset({0}.r_t, {2})))"
            "".format(name, input_descriptor, delay)
        )
        configs.append(
            "component-node name={0}.o2_t component={0}.w_o.c input={0}.c_t".format(
                name
            )
        )
        configs.append(
            "component-node name={0}.o_t component={0}.o input=Sum({0}.o1_t, {0}.o2_t)".format(
                name
            )
        )
        ...
        configs.append("# h_t")
        configs.append(
            "component-node name={0}.h_t component={0}.h input={0}.c_t".format(name)
        )

        configs.append("# g_t")
        configs.append(
            "component-node name={0}.g1_t component={0}.W_c.xr input=Append({1}, IfDefined(Offset({0}.r_t, {2})))"
            "".format(name, input_descriptor, delay)
        )
        configs.append(
            "component-node name={0}.g_t component={0}.g input={0}.g1_t".format(name)
        )

        configs.append("# parts of c_t")
        configs.append(
            "component-node name={0}.c1_t component={0}.c1  input=Append({0}.f_t, {1})"
            "".format(name, delayed_c_t_descriptor)
        )
        configs.append(
            "component-node name={0}.c2_t component={0}.c2 input=Append({0}.i_t, {0}.g_t)"
            "".format(name)
        )

        configs.append("# m_t")
        configs.append(
            "component-node name={0}.m_t component={0}.m input=Append({0}.o_t, {0}.h_t)"
            "".format(name)
        )

        # add the recurrent connections
        configs.append(
            "component name={0}.r type=BackpropTruncationComponent dim={1} {2}"
            "".format(name, cell_dim, bptrunc_str)
        )
        configs.append(
            "component-node name={0}.r_t component={0}.r input={0}.m_t".format(name)
        )
...
class XconfigLstmpLayer(XconfigLayerBase):
    ...
    def output_name(self, auxiliary_output=None):
        node_name = (
            "rp_t_batchnorm" if self.layer_type == "lstmp-batchnorm-layer" else "rp_t"
        )
        if auxiliary_output is not None:
            if auxiliary_output in self.auxiliary_outputs():
                node_name = auxiliary_output
    ...
    def _generate_lstm_config(self):
        ...
        configs.append("# i_t")
        configs.append(
            "component-node name={0}.i1_t component={0}.W_i.xr input=Append({1}, IfDefined(Offset({2}, {3})))"
        ...
        if dropout_proportion != -1.0:
            configs.append(
                "component-node name={0}.i_t_predrop component={0}.i input=Sum({0}.i1_t, {0}.i2_t)".format(
                    name
                )
            )
            configs.append(
                "component-node name={0}.i_t component={0}.dropout input={0}.i_t_predrop".format(
                    name
                )
            )
        else:
        ...
        configs.append("# f_t")
        configs.append(
            "component-node name={0}.f1_t component={0}.W_f.xr input=Append({1}, IfDefined(Offset({2}, {3})))"
            "".format(name, input_descriptor, recurrent_connection, delay)
        )
        configs.append(
            "component-node name={0}.f2_t component={0}.w_f.c  input={1}".format(
        ...
        if dropout_proportion != -1.0:
            configs.append(
                "component-node name={0}.f_t_predrop component={0}.f input=Sum({0}.f1_t, {0}.f2_t)".format(
                    name
                )
            )
            configs.append(
                "component-node name={0}.f_t component={0}.dropout input={0}.f_t_predrop".format(
                    name
                )
            )
        else:
        ...
        configs.append("# o_t")
        configs.append(
            "component-node name={0}.o1_t component={0}.W_o.xr input=Append({1}, IfDefined(Offset({2}, {3})))".format(
        ...
        if dropout_proportion != -1.0:
            configs.append(
                "component-node name={0}.o_t_predrop component={0}.o input=Sum({0}.o1_t, {0}.o2_t)".format(
                    name
                )
            )
            configs.append(
        ...
        configs.append("# g_t")
        configs.append(
            "component-node name={0}.g1_t component={0}.W_c.xr input=Append({1}, IfDefined(Offset({2}, {3})))"
            "".format(name, input_descriptor, recurrent_connection, delay)
        )
        configs.append(
            "component-node name={0}.g_t component={0}.g input={0}.g1_t".format(name)
        ...
        configs.append("# parts of c_t")
        configs.append(
            "component-node name={0}.c1_t component={0}.c1  input=Append({0}.f_t, {1})".format(
                name, delayed_c_t_descriptor
            )
        )
        configs.append(
            "component-node name={0}.c2_t component={0}.c2 input=Append({0}.i_t, {0}.g_t)".format(
                name
            )
        )
        ...
        configs.append("# m_t")
        configs.append(
            "component-node name={0}.m_t component={0}.m input=Append({0}.o_t, {0}.h_t)".format(
                name
            )
        )
        ...
        configs.append(
            "component name={0}.W_rp.m type=NaturalGradientAffineComponent input-dim={1} "
            "output-dim={2} {3} {4}".format(
                name,
                cell_dim,
        ...
        configs.append(
            "# r_t and p_t : rp_t will be the output (if we're not doing batchnorm)"
        )
        configs.append(
            "component-node name={0}.rp_t component={0}.W_rp.m input={0}.m_t"
            "".format(name)
        )
        configs.append(
            "dim-range-node name={0}.r_t_preclip input-node={0}.rp_t dim-offset=0 "
            "dim={1}".format(name, rec_proj_dim)
        )
        configs.append(
            "component-node name={0}.r_t component={0}.r input={0}.r_t_preclip".format(
                name
            )
        )
        ...
        if self.layer_type == "lstmp-batchnorm-layer":
            ...
            configs.append(
                "component name={0}.rp_t_batchnorm type=BatchNormComponent dim={1} ".format(
                    name, rec_proj_dim + nonrec_proj_dim
                )
            )
            configs.append(
                "component-node name={0}.rp_t_batchnorm component={0}.rp_t_batchnorm "
...
class XconfigFastLstmLayer(XconfigLayerBase):
    ...
    def output_name(self, auxiliary_output=None):
        node_name = (
            "m_batchnorm" if self.layer_type == "fast-lstm-batchnorm-layer" else "m"
        )
        if auxiliary_output is not None:
    ...
    def _generate_lstm_config(self):
        ...
        configs.append(
            "component name={0}.W_all type=NaturalGradientAffineComponent input-dim={1} "
            "output-dim={2} {3} {4}".format(
                name,
                input_dim + cell_dim,
                cell_dim * 4,
        ...
        configs.append(
            "component name={0}.lstm_nonlin type=LstmNonlinearityComponent "
            "cell-dim={1} {2} {3}".format(
                name, cell_dim, lstm_str, l2_regularize_option
            )
        )
        ...
        configs.append(
            "component name={0}.cm_trunc type=BackpropTruncationComponent dim={1} "
            "{2}".format(name, 2 * cell_dim, bptrunc_str)
        )

        configs.append("###  Nodes for the components above.")
        configs.append(
            "component-node name={0}.W_all component={0}.W_all input=Append({1}, "
            "IfDefined(Offset({0}.m_trunc, {2})))".format(name, input_descriptor, delay)
        )

        configs.append(
            "component-node name={0}.lstm_nonlin component={0}.lstm_nonlin "
        ...
        configs.append(
            "dim-range-node name={0}.m input-node={0}.lstm_nonlin dim-offset={1} dim={1}".format(
                name, cell_dim
            )
        )
        configs.append(
            "component-node name={0}.cm_trunc component={0}.cm_trunc input={0}.lstm_nonlin".format(
                name
            )
        )
        configs.append(
            "dim-range-node name={0}.c_trunc input-node={0}.cm_trunc dim-offset=0 dim={1}".format(
                name, cell_dim
            )
        )
        configs.append(
            "dim-range-node name={0}.m_trunc input-node={0}.cm_trunc dim-offset={1} dim={1}".format(
                name, cell_dim
            )
        )
        ...
        if self.layer_type == "fast-lstm-batchnorm-layer":
            # Add the batchnorm component, if requested to include batchnorm.
            configs.append(
                "component name={0}.m_batchnorm type=BatchNormComponent dim={1} ".format(
                    name, cell_dim
                )
            )
            configs.append(
                "component-node name={0}.m_batchnorm component={0}.m_batchnorm "
...
class XconfigLstmbLayer(XconfigLayerBase):
    ...
    def check_configs(self):
        if self.config["cell-dim"] <= 0:
            raise RuntimeError(
                "cell-dim has invalid value {0}.".format(self.config["cell-dim"])
            )
        if self.config["bottleneck-dim"] <= 0:
            raise RuntimeError(
                "bottleneck-dim has invalid value {0}.".format(
    ...
    def _generate_lstm_config(self):
        ...
        configs.append("### Begin LTSM layer '{0}'".format(name))
        configs.append(
            "component name={0}.W_all_a type=LinearComponent input-dim={1} "
        ...
        configs.append(
            "component name={0}.W_all_b type=LinearComponent input-dim={1} "
            "output-dim={2} {3} {4}".format(
                name, bottleneck_dim, cell_dim * 4, affine_str, l2_regularize_option
            )
        )
        configs.append(
            "component name={0}.W_all_b_so type=ScaleAndOffsetComponent dim={1} "
        ...
        configs.append(
            "component name={0}.cm_trunc type=BackpropTruncationComponent dim={1} {2}".format(
        ...
        configs.append("###  Nodes for the components above.")
        configs.append(
            "component-node name={0}.W_all_a component={0}.W_all_a input=Append({1}, "
            "IfDefined(Offset(Scale({2}, {0}.m_trunc), {3})))".format(
                name, input_descriptor, self_scale, delay
            )
        )
        configs.append(
            "component-node name={0}.W_all_b component={0}.W_all_b "
            "input={0}.W_all_a".format(name)
        )
        configs.append(
            "component-node name={0}.W_all_b_so component={0}.W_all_b_so "
        ...
        configs.append(
            "dim-range-node name={0}.m input-node={0}.lstm_nonlin dim-offset={1} "
        ...
        configs.append(
            "dim-range-node name={0}.c_trunc input-node={0}.cm_trunc dim-offset=0 "
            "dim={1}".format(name, cell_dim)
        )
        configs.append(
            "dim-range-node name={0}.m_trunc input-node={0}.cm_trunc dim-offset={1} "
            "dim={1}".format(name, cell_dim)
        )
        configs.append(
            "component-node name={0}.m_batchnorm component={0}.m_batchnorm "
...
class XconfigFastLstmpLayer(XconfigLayerBase):
    ...
    def output_name(self, auxiliary_output=None):
        node_name = (
            "rp_batchnorm" if self.layer_type == "fast-lstmp-batchnorm-layer" else "rp"
        )
        if auxiliary_output is not None:
            if auxiliary_output in self.auxiliary_outputs():
                node_name = auxiliary_output
    ...
    def _generate_lstm_config(self):
        ...
        configs.append("# See cu-math.h:ComputeLstmNonlinearity() for details.")
        configs.append(
            "component name={0}.lstm_nonlin type=LstmNonlinearityComponent cell-dim={1} "
            "use-dropout={2} {3} {4}".format(
                name,
                cell_dim,
        ...
        configs.append(
            "component name={0}.cr_trunc type=BackpropTruncationComponent "
            "dim={1} {2}".format(name, cell_dim + rec_proj_dim, bptrunc_str)
        )
        if dropout_proportion != -1.0:
            configs.append(
                "component name={0}.dropout_mask type=DropoutMaskComponent output-dim=3 "
                "dropout-proportion={1} ".format(name, dropout_proportion)
            )
        configs.append(
        ...
        configs.append(
            "component name={0}.W_rp type=NaturalGradientAffineComponent "
        ...
        if dropout_proportion != -1.0:
            ...
            configs.append(
                "component-node name={0}.dropout_mask component={0}.dropout_mask "
        ...
        configs.append(
            "dim-range-node name={0}.c input-node={0}.lstm_nonlin "
            "dim-offset=0 dim={1}".format(name, cell_dim)
        )
        configs.append(
            "dim-range-node name={0}.m input-node={0}.lstm_nonlin "
            "dim-offset={1} dim={1}".format(name, cell_dim)
        )
        configs.append(
            "# {0}.rp is the output node of this layer (if we're not "
            "including batchnorm)".format(name)
        )
        configs.append(
            "component-node name={0}.rp component={0}.W_rp input={0}.m".format(name)
        )
        configs.append(
            "dim-range-node name={0}.r input-node={0}.rp dim-offset=0 "
            "dim={1}".format(name, rec_proj_dim)
        )
        ...
        configs.append(
            "component-node name={0}.cr_trunc component={0}.cr_trunc "
            "input=Append({0}.c, {0}.r)".format(name)
        )
        configs.append(
            "dim-range-node name={0}.c_trunc input-node={0}.cr_trunc "
            "dim-offset=0 dim={1}".format(name, cell_dim)
        )
        configs.append(
            "dim-range-node name={0}.r_trunc input-node={0}.cr_trunc "
            "dim-offset={1} dim={2}".format(name, cell_dim, rec_proj_dim)
        )
        if self.layer_type == "fast-lstmp-batchnorm-layer":
            # Add the batchnorm component, if requested to include batchnorm.
            configs.append(
                "component name={0}.rp_batchnorm type=BatchNormComponent dim={1} ".format(
                    name, rec_proj_dim + nonrec_proj_dim
                )
            )
            configs.append(
                "component-node name={0}.rp_batchnorm component={0}.rp_batchnorm "
