...
parser = argparse.ArgumentParser(
    description="Train and evaluate a neural " "language model with PyTorch."
)
# Model options
parser.add_argument(
    "--data", type=str, default="./data/pytorchnn", help="location of the data corpus"
)
parser.add_argument(
    "--model",
    type=str,
...
parser.add_argument("--seq_len", type=int, default=35, help="sequence length limit")
parser.add_argument("--clip", type=float, default=0.25, help="gradient clipping")
parser.add_argument(
    "--dropout", type=float, default=0.2, help="dropout applied to layers"
)
parser.add_argument(
...
def train():
    ...
    for batch, i in enumerate(range(0, train_data.size(0) - 1, args.seq_len)):
        ...
        if batch % args.log_interval == 0 and batch > 0:
            ...
            print(
                "| epoch {:3d} | {:5d}/{:5d} batches | lr {:02.3f} | "
